...
func NewAzurermBotChannelDirectlineInvalidResourceGroupNameRule() *AzurermBotChannelDirectlineInvalidResourceGroupNameRule {
	return &AzurermBotChannelDirectlineInvalidResourceGroupNameRule{
...
func (r *AzurermBotChannelDirectlineInvalidResourceGroupNameRule) Name() string {
	return "azurerm_bot_channel_directline_invalid_resource_group_name"
}
...
func (r *AzurermBotChannelDirectlineInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
