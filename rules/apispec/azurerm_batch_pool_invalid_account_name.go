...
func NewAzurermBatchPoolInvalidAccountNameRule() *AzurermBatchPoolInvalidAccountNameRule {
	return &AzurermBatchPoolInvalidAccountNameRule{
...
func (r *AzurermBatchPoolInvalidAccountNameRule) Name() string {
	return "azurerm_batch_pool_invalid_account_name"
}
...
func (r *AzurermBatchPoolInvalidAccountNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
