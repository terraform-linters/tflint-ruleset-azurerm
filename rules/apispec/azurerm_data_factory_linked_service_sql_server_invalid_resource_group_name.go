...
func NewAzurermDataFactoryLinkedServiceSQLServerInvalidResourceGroupNameRule() *AzurermDataFactoryLinkedServiceSQLServerInvalidResourceGroupNameRule {
	return &AzurermDataFactoryLinkedServiceSQLServerInvalidResourceGroupNameRule{
...
func (r *AzurermDataFactoryLinkedServiceSQLServerInvalidResourceGroupNameRule) Name() string {
	return "azurerm_data_factory_linked_service_sql_server_invalid_resource_group_name"
}
...
func (r *AzurermDataFactoryLinkedServiceSQLServerInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
