...
func NewAzurermCosmosdbGremlinDatabaseInvalidAccountNameRule() *AzurermCosmosdbGremlinDatabaseInvalidAccountNameRule {
	return &AzurermCosmosdbGremlinDatabaseInvalidAccountNameRule{
...
func (r *AzurermCosmosdbGremlinDatabaseInvalidAccountNameRule) Name() string {
	return "azurerm_cosmosdb_gremlin_database_invalid_account_name"
}
...
func (r *AzurermCosmosdbGremlinDatabaseInvalidAccountNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
