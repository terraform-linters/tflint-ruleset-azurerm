...
func NewAzurermStorageAccountInvalidResourceGroupNameRule() *AzurermStorageAccountInvalidResourceGroupNameRule {
	return &AzurermStorageAccountInvalidResourceGroupNameRule{
...
func (r *AzurermStorageAccountInvalidResourceGroupNameRule) Name() string {
	return "azurerm_storage_account_invalid_resource_group_name"
}
...
func (r *AzurermStorageAccountInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
