...
func NewAzurermDataFactoryPipelineInvalidResourceGroupNameRule() *AzurermDataFactoryPipelineInvalidResourceGroupNameRule {
	return &AzurermDataFactoryPipelineInvalidResourceGroupNameRule{
...
func (r *AzurermDataFactoryPipelineInvalidResourceGroupNameRule) Name() string {
	return "azurerm_data_factory_pipeline_invalid_resource_group_name"
}
...
func (r *AzurermDataFactoryPipelineInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
