...
func NewAzurermVirtualMachineScaleSetInvalidPriorityRule() *AzurermVirtualMachineScaleSetInvalidPriorityRule {
	return &AzurermVirtualMachineScaleSetInvalidPriorityRule{
...
func (r *AzurermVirtualMachineScaleSetInvalidPriorityRule) Name() string {
	return "azurerm_virtual_machine_scale_set_invalid_priority"
}
...
func (r *AzurermVirtualMachineScaleSetInvalidPriorityRule) Severity() tflint.Severity {
	return tflint.ERROR
}
