...
func NewAzurermBotConnectionInvalidResourceGroupNameRule() *AzurermBotConnectionInvalidResourceGroupNameRule {
	return &AzurermBotConnectionInvalidResourceGroupNameRule{
...
func (r *AzurermBotConnectionInvalidResourceGroupNameRule) Name() string {
	return "azurerm_bot_connection_invalid_resource_group_name"
}
...
func (r *AzurermBotConnectionInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
