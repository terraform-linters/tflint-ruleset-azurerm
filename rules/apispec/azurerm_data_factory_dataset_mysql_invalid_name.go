...
func NewAzurermDataFactoryDatasetMysqlInvalidNameRule() *AzurermDataFactoryDatasetMysqlInvalidNameRule {
	return &AzurermDataFactoryDatasetMysqlInvalidNameRule{
...
func (r *AzurermDataFactoryDatasetMysqlInvalidNameRule) Name() string {
	return "azurerm_data_factory_dataset_mysql_invalid_name"
}
...
func (r *AzurermDataFactoryDatasetMysqlInvalidNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
