...
func NewAzurermPostgresqlFirewallRuleInvalidStartIPAddressRule() *AzurermPostgresqlFirewallRuleInvalidStartIPAddressRule {
	return &AzurermPostgresqlFirewallRuleInvalidStartIPAddressRule{
...
func (r *AzurermPostgresqlFirewallRuleInvalidStartIPAddressRule) Name() string {
	return "azurerm_postgresql_firewall_rule_invalid_start_ip_address"
}
...
func (r *AzurermPostgresqlFirewallRuleInvalidStartIPAddressRule) Severity() tflint.Severity {
	return tflint.ERROR
}
