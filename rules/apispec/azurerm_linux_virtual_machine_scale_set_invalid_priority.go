...
func NewAzurermLinuxVirtualMachineScaleSetInvalidPriorityRule() *AzurermLinuxVirtualMachineScaleSetInvalidPriorityRule {
	return &AzurermLinuxVirtualMachineScaleSetInvalidPriorityRule{
...
func (r *AzurermLinuxVirtualMachineScaleSetInvalidPriorityRule) Name() string {
	return "azurerm_linux_virtual_machine_scale_set_invalid_priority"
}
...
func (r *AzurermLinuxVirtualMachineScaleSetInvalidPriorityRule) Severity() tflint.Severity {
	return tflint.ERROR
}
