...
func NewAzurermCosmosdbAccountInvalidResourceGroupNameRule() *AzurermCosmosdbAccountInvalidResourceGroupNameRule {
	return &AzurermCosmosdbAccountInvalidResourceGroupNameRule{
...
func (r *AzurermCosmosdbAccountInvalidResourceGroupNameRule) Name() string {
	return "azurerm_cosmosdb_account_invalid_resource_group_name"
}
...
func (r *AzurermCosmosdbAccountInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
