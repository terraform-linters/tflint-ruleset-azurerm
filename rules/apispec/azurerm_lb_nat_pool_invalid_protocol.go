...
func NewAzurermLbNatPoolInvalidProtocolRule() *AzurermLbNatPoolInvalidProtocolRule {
	return &AzurermLbNatPoolInvalidProtocolRule{
...
func (r *AzurermLbNatPoolInvalidProtocolRule) Name() string {
	return "azurerm_lb_nat_pool_invalid_protocol"
}
...
func (r *AzurermLbNatPoolInvalidProtocolRule) Severity() tflint.Severity {
	return tflint.ERROR
}
