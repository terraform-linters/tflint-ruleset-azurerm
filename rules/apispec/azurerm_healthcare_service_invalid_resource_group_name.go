...
func NewAzurermHealthcareServiceInvalidResourceGroupNameRule() *AzurermHealthcareServiceInvalidResourceGroupNameRule {
	return &AzurermHealthcareServiceInvalidResourceGroupNameRule{
...
func (r *AzurermHealthcareServiceInvalidResourceGroupNameRule) Name() string {
	return "azurerm_healthcare_service_invalid_resource_group_name"
}
...
func (r *AzurermHealthcareServiceInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
