...
func NewAzurermLinuxVirtualMachineScaleSetInvalidUpgradeModeRule() *AzurermLinuxVirtualMachineScaleSetInvalidUpgradeModeRule {
	return &AzurermLinuxVirtualMachineScaleSetInvalidUpgradeModeRule{
...
func (r *AzurermLinuxVirtualMachineScaleSetInvalidUpgradeModeRule) Name() string {
	return "azurerm_linux_virtual_machine_scale_set_invalid_upgrade_mode"
}
...
func (r *AzurermLinuxVirtualMachineScaleSetInvalidUpgradeModeRule) Severity() tflint.Severity {
	return tflint.ERROR
}
