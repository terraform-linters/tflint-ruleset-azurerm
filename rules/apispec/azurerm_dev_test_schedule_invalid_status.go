...
func NewAzurermDevTestScheduleInvalidStatusRule() *AzurermDevTestScheduleInvalidStatusRule {
	return &AzurermDevTestScheduleInvalidStatusRule{
...
func (r *AzurermDevTestScheduleInvalidStatusRule) Name() string {
	return "azurerm_dev_test_schedule_invalid_status"
}
...
func (r *AzurermDevTestScheduleInvalidStatusRule) Severity() tflint.Severity {
	return tflint.ERROR
}
