...
func NewAzurermBotChannelsRegistrationInvalidResourceGroupNameRule() *AzurermBotChannelsRegistrationInvalidResourceGroupNameRule {
	return &AzurermBotChannelsRegistrationInvalidResourceGroupNameRule{
...
func (r *AzurermBotChannelsRegistrationInvalidResourceGroupNameRule) Name() string {
	return "azurerm_bot_channels_registration_invalid_resource_group_name"
}
...
func (r *AzurermBotChannelsRegistrationInvalidResourceGroupNameRule) Severity() tflint.Severity {
	return tflint.ERROR
}
