...
func NewAzurermRedisCacheInvalidFamilyRule() *AzurermRedisCacheInvalidFamilyRule {
	return &AzurermRedisCacheInvalidFamilyRule{
...
func (r *AzurermRedisCacheInvalidFamilyRule) Name() string {
	return "azurerm_redis_cache_invalid_family"
}
...
func (r *AzurermRedisCacheInvalidFamilyRule) Severity() tflint.Severity {
	return tflint.ERROR
}
	...
	for _, resource := range resources.Blocks {
		...
		err := runner.EvaluateExpr(attribute.Expr, func (val string) error {
			...
			if !found {
				runner.EmitIssue(
					r,
					fmt.Sprintf(`"%s" is an invalid value as family`, truncateLongMessage(val)),
