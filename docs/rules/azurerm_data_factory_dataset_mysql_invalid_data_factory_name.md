...
# azurerm_data_factory_dataset_mysql_invalid_data_factory_name
...
Error: "..." does not match valid pattern ^[A-Za-z0-9]+(?:-[A-Za-z0-9]+)*$ (azurerm_data_factory_dataset_mysql_invalid_data_factory_name)

  on template.tf line 2:
  2:   data_factory_name = ... // invalid value

Reference: https://github.com/terraform-linters/tflint-ruleset-azurerm/blob/v0.1.0/docs/rules/azurerm_data_factory_dataset_mysql_invalid_data_factory_name.md
