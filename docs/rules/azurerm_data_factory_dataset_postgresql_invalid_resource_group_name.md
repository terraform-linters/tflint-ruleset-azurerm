...
# azurerm_data_factory_dataset_postgresql_invalid_resource_group_name
...
Error: "..." does not match valid pattern ^[-\w\._\(\)]+$ (azurerm_data_factory_dataset_postgresql_invalid_resource_group_name)

  on template.tf line 2:
  2:   resource_group_name = ... // invalid value

Reference: https://github.com/terraform-linters/tflint-ruleset-azurerm/blob/v0.1.0/docs/rules/azurerm_data_factory_dataset_postgresql_invalid_resource_group_name.md
