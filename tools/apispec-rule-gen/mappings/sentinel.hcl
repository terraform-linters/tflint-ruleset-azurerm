mapping "azurerm_sentinel_alert_rule_ms_security_incident" {
  import_path = "azure-rest-api-specs/specification/securityinsights/resource-manager/Microsoft.SecurityInsights/preview/2019-01-01-preview/SecurityInsights.json"
