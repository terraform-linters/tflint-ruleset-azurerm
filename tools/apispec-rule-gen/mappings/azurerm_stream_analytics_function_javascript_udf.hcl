mapping "azurerm_stream_analytics_function_javascript_udf" {
  import_path = "azure-rest-api-specs/specification/streamanalytics/resource-manager/Microsoft.StreamAnalytics/StreamAnalytics/stable/2020-03-01/functions.json"
