mapping "azurerm_cosmosdb_account" {
  import_path = "azure-rest-api-specs/specification/cosmos-db/resource-manager/Microsoft.DocumentDB/stable/2020-03-01/cosmos-db.json"
...
mapping "azurerm_cosmosdb_cassandra_keyspace" {
  ...
  throughput          = OptionsResource.throughput
}
